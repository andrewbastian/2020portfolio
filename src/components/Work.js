    ...
    return (
        <DialogTrigger isDismissable>
            ...
            <Dialog>
                ...
                <Header>
                    For more projects, checkout my Github pofile: &nbsp;
                    <Link>
                ...
                <Content>
                    <Link>
                        <a href='https://github.com/andrewbastian/watermyplants-frontend'>
                            <Text>Water My Plants App: Repository Link</Text>
                        </a>
                    </Link>
                    <ReactTinyLink
                        cardSize='small'
                    ...
                    <Link>
                        <a href='https://github.com/andrewbastian/designhub-frontend'>
                            <Text>Design Hub: Repository Link</Text>
                        </a>
                    </Link>
                    <ReactTinyLink
                        cardSize='small'
                    ...
                    <Link>
                        <a href='https://github.com/andrewbastian/cookbook-marketing'>
                            <Text>Secret Family Cookbook: Repository Link</Text>
                        </a>
                    </Link>
                    <ReactTinyLink
                        cardSize='small'
